...
<script>
    ...
    import MessageGroup from "../../common/review/MessageGroup";
    import MessageEditor from "../../common/review/MessageEditor";
    import {normalizeData as normalize} from "utils/utils";
